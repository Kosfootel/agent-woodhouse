...
from app.routers import security, devices, alerts, stats, setup, agents, setup_session, setup_router_credentials, events
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://192.168.50.30:8085", "http://localhost:3000", "http://192.168.50.30:3000"],
